                ...
                <div class="col-lg-12">
                    ...
                    <div class="featured__controls">
                        <ul>
                            ...
                            <li data-filter=".Gorengan">Gorengan</li>
                ...
                try {
                    ...
                    if (count($result) > 0) {
                        foreach ($result as $row) {
                            ...
                            echo '<ul class="pagination mix Mie Gorengan Minuman Snack">';
                            for ($page = 1; $page <= ceil(count($result) / $productsPerPage); $page++) {
                                if ($page === 1) {
                                    echo '<li class="page-item"><a class="page-link" href="index.php">' . $page . '</a></li>';
                                } else {
