                                        ...
                                        <table id="datatablesSimple">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?= $row['id_user']; ?></td>
                                                    <td>
                                                    <a class="btn btn-warning btn-sm" type="button" href="edit-user.php?id_user=<?= $row['id_user']; ?>?form=4"><i class="fa-solid fa-pen-to-square"></i></a>
                                                    ...
                                                    $sthandler->execute();
                                                        ...
                                                        if($sthandler->rowCount() > 0){
                                                            echo "<script>usernameexist();</script>";
                                                                ...
                                                                $sql = 'INSERT INTO kewarganegaraan (id_negara ,nama_negara, tgl_input, user_input, id_user) VALUES (:id_negara,:nama_negara,:tgl_input,:user_input,:id_user)';    
